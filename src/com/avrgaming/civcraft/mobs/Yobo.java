...
public class Yobo extends CommonCustomMob implements ICustomMob {
	...
	public void onCreateAttributes() {
		...
		case HUNTING:
			...
			modifySpeed(1.1);
			this.setAttack(8.0);
			this.addVanillaDrop(CivData.PORK, (short)0, 0.15);
			this.addVanillaDrop(CivData.BEEF, (short)0, 0.15);
			this.addVanillaDrop(CivData.CHICKEN, (short)0, 0.15);
			this.addVanillaDrop(CivData.MUTTON, (short)0, 0.15);
			this.coinDrop(5, 30);
			break;
