...
public class Ferosse extends CommonCustomMob implements ICustomMob {
	...
	public String getBaseEntity() {
		return MobBaseWolf.class.getName();
	}
	
	@Override
	public String getClassName() {
		return Ferosse.class.getName();
	}
	
	public static void register() {
		    setValidBiome(CustomMobType.FEROSSE, CustomMobLevel.LESSER, Biome.FROZEN_RIVER);
		    setValidBiome(CustomMobType.FEROSSE, CustomMobLevel.LESSER, Biome.FROZEN_OCEAN);
		    setValidBiome(CustomMobType.FEROSSE, CustomMobLevel.LESSER, Biome.COLD_BEACH);
		    setValidBiome(CustomMobType.FEROSSE, CustomMobLevel.LESSER, Biome.COLD_TAIGA);
		    
		    setValidBiome(CustomMobType.FEROSSE, CustomMobLevel.GREATER, Biome.COLD_TAIGA_HILLS);
		    setValidBiome(CustomMobType.FEROSSE, CustomMobLevel.GREATER, Biome.COLD_TAIGA_MOUNTAINS);
		    
		    setValidBiome(CustomMobType.FEROSSE, CustomMobLevel.ELITE, Biome.ICE_PLAINS);
		    setValidBiome(CustomMobType.FEROSSE, CustomMobLevel.GREATER, Biome.ICE_MOUNTAINS);
		    
		    setValidBiome(CustomMobType.FEROSSE, CustomMobLevel.BRUTAL, Biome.ICE_PLAINS_SPIKES);
	}
