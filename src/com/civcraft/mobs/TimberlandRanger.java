...
public class TimberlandRanger extends CommonCustomMob implements ICustomMob {
	...
	public String getBaseEntity() {
		return MobBaseSkeleton.class.getName();
	}
	
	@Override
	public String getClassName() {
		return TimberlandRanger.class.getName();
	}
	
	public static void register() {
		    setValidBiome(CustomMobType.TIMBERLAND_RANGER, CustomMobLevel.LESSER, Biome.FROZEN_RIVER);
		    setValidBiome(CustomMobType.TIMBERLAND_RANGER, CustomMobLevel.LESSER, Biome.FROZEN_OCEAN);
		    setValidBiome(CustomMobType.TIMBERLAND_RANGER, CustomMobLevel.LESSER, Biome.COLD_BEACH);
		    setValidBiome(CustomMobType.TIMBERLAND_RANGER, CustomMobLevel.LESSER, Biome.COLD_TAIGA);
		    
		    setValidBiome(CustomMobType.TIMBERLAND_RANGER, CustomMobLevel.GREATER, Biome.COLD_TAIGA_HILLS);
		    setValidBiome(CustomMobType.TIMBERLAND_RANGER, CustomMobLevel.GREATER, Biome.COLD_TAIGA_MOUNTAINS);
		    
		    setValidBiome(CustomMobType.TIMBERLAND_RANGER, CustomMobLevel.ELITE, Biome.ICE_PLAINS);
		    setValidBiome(CustomMobType.TIMBERLAND_RANGER, CustomMobLevel.GREATER, Biome.ICE_MOUNTAINS);
		    
		    setValidBiome(CustomMobType.TIMBERLAND_RANGER, CustomMobLevel.BRUTAL, Biome.ICE_PLAINS_SPIKES);
	}
