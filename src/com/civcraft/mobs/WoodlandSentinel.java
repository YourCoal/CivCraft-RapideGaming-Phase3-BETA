...
public class WoodlandSentinel extends CommonCustomMob implements ICustomMob {
	...
	public String getBaseEntity() {
		return MobBaseEnderman.class.getName();
	}
	
	@Override
	public String getClassName() {
		return WoodlandSentinel.class.getName();
	}
	
	public static void register() {
		    setValidBiome(CustomMobType.WOODLAND_SENTINEL, CustomMobLevel.LESSER, Biome.FROZEN_RIVER);
		    setValidBiome(CustomMobType.WOODLAND_SENTINEL, CustomMobLevel.LESSER, Biome.FROZEN_OCEAN);
		    setValidBiome(CustomMobType.WOODLAND_SENTINEL, CustomMobLevel.LESSER, Biome.COLD_BEACH);
		    setValidBiome(CustomMobType.WOODLAND_SENTINEL, CustomMobLevel.LESSER, Biome.COLD_TAIGA);
		    
		    setValidBiome(CustomMobType.WOODLAND_SENTINEL, CustomMobLevel.GREATER, Biome.COLD_TAIGA_HILLS);
		    setValidBiome(CustomMobType.WOODLAND_SENTINEL, CustomMobLevel.GREATER, Biome.COLD_TAIGA_MOUNTAINS);
		    
		    setValidBiome(CustomMobType.WOODLAND_SENTINEL, CustomMobLevel.ELITE, Biome.ICE_PLAINS);
		    setValidBiome(CustomMobType.WOODLAND_SENTINEL, CustomMobLevel.GREATER, Biome.ICE_MOUNTAINS);
		    
		    setValidBiome(CustomMobType.WOODLAND_SENTINEL, CustomMobLevel.BRUTAL, Biome.ICE_PLAINS_SPIKES);
	}
