package com.civcraft.pvplogger;
		...
		if (taggedPlayers.containsKey(event.getPlayer().getName())) {
			...
			try {
				...
				if (now.before(expire)) {
					...
					MobLibEntity entity = MobLib.createNamedEntity("com.civcraft.mobs.LoboZombie", event.getPlayer().getLocation(), event.getPlayer().getName());
