...
public class MobBaseBlaze extends EntityBlaze implements ISpawnable {
	...
	public MobBaseBlaze(World world) {
		super(world);
	}
	
	public MobBaseBlaze(World world, ICustomMob customMob) {
		super(world);
	...
	public static Entity spawnCustom(Location loc, ICustomMob iCustom) {
		...
		MobBaseBlaze blaze = new MobBaseBlaze(mcWorld, iCustom);
