...
public class MobBaseCreeper extends EntityCreeper implements ISpawnable {
	...
	public MobBaseCreeper(World world) {
		super(world);
	}
	
	public MobBaseCreeper(World world, ICustomMob customMob) {
		super(world);
	...
	public static Entity spawnCustom(Location loc, ICustomMob iCustom) {
		...
		MobBaseCreeper creeper = new MobBaseCreeper(mcWorld, iCustom);
