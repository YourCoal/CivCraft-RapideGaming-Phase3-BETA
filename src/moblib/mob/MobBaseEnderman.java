...
public class MobBaseEnderman extends EntityEnderman implements ISpawnable {
	...
	public MobBaseEnderman(World world) {
		super(world);
	}
	
	public MobBaseEnderman(World world, ICustomMob customMob) {
		super(world);
	...
	public static Entity spawnCustom(Location loc, ICustomMob iCustom) {
		...
		MobBaseEnderman enderman = new MobBaseEnderman(mcWorld, iCustom);
