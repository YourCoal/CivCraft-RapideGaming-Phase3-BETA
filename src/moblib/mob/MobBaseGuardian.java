...
public class MobBaseGuardian extends EntityGuardian implements ISpawnable {
	...
	public MobBaseGuardian(World world) {
		super(world);
	}
	
	public MobBaseGuardian(World world, ICustomMob customMob) {
		super(world);
	...
	public static Entity spawnCustom(Location loc, ICustomMob iCustom) {
		...
		MobBaseGuardian guardian = new MobBaseGuardian(mcWorld, iCustom);
