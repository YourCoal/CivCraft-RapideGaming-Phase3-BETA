...
public class MobBaseSkeleton extends EntitySkeleton implements ISpawnable {
	...
	public MobBaseSkeleton(World world) {
		super(world);
	}
	
	public MobBaseSkeleton(World world, ICustomMob customMob) {
		super(world);
	...
	public static Entity spawnCustom(Location loc, ICustomMob iCustom) {
		...
		MobBaseSkeleton skeleton = new MobBaseSkeleton(mcWorld, iCustom);
