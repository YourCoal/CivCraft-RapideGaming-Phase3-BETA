...
public class MobBaseSnowman extends EntitySnowman implements ISpawnable {
	public ICustomMob customMob = null;

	public MobBaseSnowman(World world) {
		super(world);

	}
	
	public MobBaseSnowman(World world, ICustomMob custom) {
		super(world);
	...
	public static Entity spawnCustom(Location loc, ICustomMob iCustom) {
		...
		MobBaseSnowman snowman = new MobBaseSnowman(mcWorld, iCustom);
