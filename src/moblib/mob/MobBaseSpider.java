...
public class MobBaseSpider extends EntitySpider implements ISpawnable {
	...
	public MobBaseSpider(World world) {
		super(world);
	}
	
	public MobBaseSpider(World world, ICustomMob customMob) {
		super(world);
	...
	public static Entity spawnCustom(Location loc, ICustomMob iCustom) {
		...
		MobBaseSpider spider = new MobBaseSpider(mcWorld, iCustom);
