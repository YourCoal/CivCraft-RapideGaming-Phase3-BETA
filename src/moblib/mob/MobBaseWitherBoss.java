...
public class MobBaseWitherBoss extends EntityWither implements ISpawnable {
	...
	public MobBaseWitherBoss(World world) {
		super(world);
	}
	
	public MobBaseWitherBoss(World world, ICustomMob customMob) {
		super(world);
	...
	public static Entity spawnCustom(Location loc, ICustomMob iCustom) {
		...
		MobBaseWitherBoss witherboss = new MobBaseWitherBoss(mcWorld, iCustom);
