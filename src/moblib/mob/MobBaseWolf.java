...
public class MobBaseWolf extends EntityWolf implements ISpawnable {
	...
	public MobBaseWolf(World world) {
		super(world);
	}
	
	public MobBaseWolf(World world, ICustomMob customMob) {
		super(world);
	...
	public static Entity spawnCustom(Location loc, ICustomMob iCustom) {
		...
		MobBaseWolf wolf = new MobBaseWolf(mcWorld, iCustom);
